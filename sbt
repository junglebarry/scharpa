...
INTERNAL_OPTS="-Dfile.encoding=UTF-8 -Xss4M -Xmx2048M -XX:MaxPermSize=1024M -XX:ReservedCodeCacheSize=128M -XX:+CMSClassUnloadingEnabled -XX:+UseConcMarkSweepGC"
